...
- **DNA Storage Pipeline** – Modular Reed–Solomon library for DNA storage (fun side project) → [GitHub](https://github.com/feeka/dna-storage) - inspired by the [DNAStoralator](https://github.com/gadihh/DNAStoralator.git).
- **metaTopoGraph** – extracts de Bruijn graph topology features - planned to make train an ML model on graph topology → [GitHub]([https://github.com/feeka/dna-storage](https://github.com/feeka/metaTopoGraph/tree/main))
